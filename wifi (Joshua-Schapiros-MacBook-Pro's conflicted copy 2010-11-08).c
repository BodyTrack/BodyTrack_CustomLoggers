...
void Wifi_Init(uint32_t baud){
	...
	if(baud == 921600){
		Wifi_Usart.BAUDCTRLA = 5 & 0xFF;                                           
		Wifi_Usart.BAUDCTRLB = (8 << USART_BSCALE0_bp)|(5 >> 8);
	} else if(baud == 460800){
		Wifi_Usart.BAUDCTRLA = 37 & 0xFF;                                           
		Wifi_Usart.BAUDCTRLB = (11 << USART_BSCALE0_bp)|(37 >> 8);		
	} else if(baud == 230400){
		Wifi_Usart.BAUDCTRLA = 27 & 0xFF;
		Wifi_Usart.BAUDCTRLB = (0b00001101 << USART_BSCALE0_bp)|(27 >> 8);
	} else if(baud == 115200){
		Wifi_Usart.BAUDCTRLA = 123 & 0xFF;
		Wifi_Usart.BAUDCTRLB = (0b00001100 << USART_BSCALE0_bp)|(123 >> 8);
	} else {	// set to 9600
		Wifi_Usart.BAUDCTRLA = 103 & 0xFF;                                           
		Wifi_Usart.BAUDCTRLB = (0 << USART_BSCALE0_bp)|(103 >> 8);
	}
